import json
import time
url=['https://login.taobao.com/member/login.jhtml?redirectURL=http%3A%2F%2Fwww.taobao.com%2F','https://www.jd.com','https://mobile.yangkeduo.com/login.html']
filename=['taobao','jd','pinduoduo']
print('操作流程:\n1-选择需要获取cookie的网站\n2-在弹出的窗口中手动操作进行登录\n3-cookie将自动保存')
print('\n输入数字打开网站\n0>淘宝\t1>京东\t2>拼多多(仅支持手机验证码登录)')
user=int(input())
